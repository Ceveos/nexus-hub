...
export function Logo({ ...props }: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg aria-hidden="true" fill="#24AFF8" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" style={{ fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2 }} {...props}>
    <g transform="matrix(0.157267,0,0,0.151608,-27.2183,-17.5274)">
